...
class ScoreCalc
  ...
  def initialize
    @elements = {
      ...
      ## Jump
      "3A": OpenStruct.new({name: "3A", type: :jump, bv: 8.5, v: 5.9, v1: 0, 
                             dg: "2A", sov: [1,1,1,1,1,1,1]}),
      "3Lz": OpenStruct.new({name: "3Lz", type: :jump, bv: 6.0, v: 4.2, v1: 3.6, 
                              dg: "2Lz", sov: [1,1,1,1,1,1,1]}),
      "2Lz": OpenStruct.new({name: "2Lz",  type: :jump, bv: 2.1, v: 1.5, v1: 1.4, 
                              dg: "1Lz", sov: [1,1,1,1,1,1,1]}),
      "3Lo": OpenStruct.new({name: "3Lo",  type: :jump, bv: 5.1, v: 3.6, 
                              dg: "2T", sov: [-2.1, -1.4, -0.7, 0, 0.7, 1.4, 2.1]}),
      "3T": OpenStruct.new({name: "3T",  type: :jump, bv: 4.3, v: 3.0, 
                             dg: "2T", sov: [-2.1, -1.4, -0.7, 0, 0.7, 1.4, 2.1]}),
